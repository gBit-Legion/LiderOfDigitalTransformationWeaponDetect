...
class RTSPCamera:
    ...
    def process_video(self):
        ...
        while True:
            ...
            return StreamingResponse(self.process_video(), media_type="multipart/x-mixed-replace; boundary=frame")


@app.post("/serve/{camera_id}")
